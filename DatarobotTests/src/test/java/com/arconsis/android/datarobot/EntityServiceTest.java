...
import com.arconsis.android.datrobot.test.data.PatternValidatorEntity;
...
public class EntityServiceTest {
	...
	public void saveSuccessfulValidatingEntity() {
		...
		EntityService<PatternValidatorEntity> service = new EntityService<PatternValidatorEntity>(
				context,
				PatternValidatorEntity.class,
				ValidationToggle.ON,
				dbCreator);
		try {
			service.save(entity);
