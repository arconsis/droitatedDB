...
import com.arconsis.android.datarobot.validation.AccumulatedValidationResult;
import com.arconsis.android.datarobot.validation.CustomValidator;
import com.arconsis.android.datarobot.validation.ValidationResult;
...
class DatabaseValidator<T> {
    ...
    private void validate(Object validatingObject, AccumulatedValidationResult validationResult, Set<Object> alreadyValidated, int currentDepth, int maxDepth) {
        try {
            EntityInfo entityInfo = SchemaUtil.getEntityInfo(validatingObject.getClass(), context.getPackageName());
