...
@Entity
 public class BidirectionalTwo {
	 ...
	 private String name;
	 @Relationship
	 private BidirectionalOne entity;

	 public BidirectionalTwo() {
	 }

	 public BidirectionalTwo(final Integer id, final String name) {
		 this._id = id;
		 this.name = name;
	 }
	 ...
	 public BidirectionalOne getEntity() {
		 return entity;
	 }

	 public void setEntity(final BidirectionalOne entity) {
		 this.entity = entity;
	 }
