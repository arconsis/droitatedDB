...
@Entity
 public class BidirectionalOne {
	 ...
	 private String name;
	 @Relationship
	 private BidirectionalTwo entity;

	 public BidirectionalOne() {
	 }

	 public BidirectionalOne(final Integer id, final String name) {
		 this._id = id;
		 this.name = name;
	 }
	 ...
	 public BidirectionalTwo getEntity() {
		 return entity;
	 }

	 public void setEntity(final BidirectionalTwo entity) {
		 this.entity = entity;
	 }
 }
