...
import org.droitateddb.test.data.Single;
import org.droitateddb.test.data.generated.CommentContentProvider;
import org.droitateddb.test.data.generated.DB;
import org.droitateddb.test.data.generated.SingleContentProvider;
...
public class ContentProviderTest extends BasePersistenceTest {
    ...
    public void testURIS() {
        ...
        assertThat(uriForItem.toString()).isEqualTo("content://org.droitateddb.test.data.generated.provider.comment/comment/1");
        Uri uri = CommentContentProvider.uri(DB.CommentTable.TABLE_NAME);
        assertThat(uri.toString()).isEqualTo("content://org.droitateddb.test.data.generated.provider.comment/comment");
    }
