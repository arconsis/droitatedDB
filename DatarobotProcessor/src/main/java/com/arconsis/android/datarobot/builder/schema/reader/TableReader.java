...
import com.arconsis.android.datarobot.builder.schema.visitor.AssociationElementResolvingTypeVisitor;
import com.arconsis.android.datarobot.builder.schema.visitor.ColumnElementResolvingTypeVisitor;
import com.arconsis.android.datarobot.builder.schema.visitor.EmptyContructorVisitor;
...
public class TableReader implements Reader<Table> {
	...
	public TableReader(final TypeElement entity, final Set<String> entityNames, final Messager messager) {
		this.entity = entity;
